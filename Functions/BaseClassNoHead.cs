...
{
    public class BaseClassNoHead : CollectionMethods
    {
        ...
        public BaseClassNoHead(Account Account)
        {
        ...
        public void DownloadExport(String ExportGreyButton, String ExportButton)
        {
            WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(30));
            wait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.XPath(ExportGreyButton)));
            Console.WriteLine("Waited until export button becomes clickable");
            System.Threading.Thread.Sleep(2000);

            //Download export file
            wait.Until(ExpectedConditions.ElementExists(By.XPath(ExportButton)));
            IWebElement ExportData = driver.FindElement(By.XPath(ExportButton));
            js.ExecuteScript("arguments[0].click();", ExportData);
            Console.WriteLine("Click on Export excel");

            wait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.XPath(ExportGreyButton)));
            Console.WriteLine("Waited until export downloaded is ready");
