...
{
    public class Permissions_Assign_Permission_Section: BaseClass
    {
        public void PermissionsAssignPermissionSection(Xpath__Permissions Xpath, Values__Permissions Value)
        {
            try
            { 
                ...
                //Open Menu + click on Permissions Section + Permission Section
                ...
                foreach (List<string> Data in Vehicles)
                {
                    ...
                    Console.WriteLine("Verified presence of VIN for " + Data[0]);
                    ...
                    Console.WriteLine("Verified presence of Alias for " + Data[0]);
                    ...
                    Console.WriteLine("Verified presence of Contract Reference for " + Data[0]);

                    //Verify the presence of Account
                    wait.Until(ExpectedConditions.ElementExists(By.XPath(Data[13])));
                    //Assert.That(driver.FindElement(By.XPath(Data[13])).Text, Is.EqualTo(Value.Account));
                    Console.WriteLine("Verified presence of Account for " + Data[0]);
