...
namespace myiveco_selenium.Xpath
{
    public class Xpath__Ranking
    {
        ...
        public String VehiclesRanking = "//*[@class=\"row widget-header\"]//div[contains (text(),'Vehicles ranking')]";
        ...
        public String DrivingStyleEvaluation = "//pfe-table[@id='myGridVehicles']//div[@class='ag-header-row ag-header-row-column-group']/div[@class='ag-header-group-cell ag-focus-managed ag-header-group-cell-with-group' and @col-id='2_0']//span[@class='ag-icon ag-icon-contracted']";
        ...
        public String DrivingStyleEvaluationButtonExpand = "//pfe-table[@id='myGridVehicles']//div[@class='ag-header-row ag-header-row-column-group']/div[@class='ag-header-group-cell ag-focus-managed ag-header-group-cell-with-group' and @col-id='2_0']//span[@class='ag-icon ag-icon-expanded']";

        // Download test xpath
        public String ExportDataDrivers = "//pfe-table[@id='myGridDrivers']//a[contains(text(),'Export Data')]";
        public String ExportDataVehicles = "//pfe-table[@id='myGridVehicles']//a[contains(text(),'Export Data')]";
        public String ExportDataGreyDrivers = "//pfe-table[@id='myGridDrivers']//pfe-cta[@aria-disabled='true']";
        public String ExportDataGreyVehicles = "//pfe-table[@id='myGridVehicles']//pfe-cta[@aria-disabled='true']";


        //KPI Vehicles Ranking Bus electric
        ...
        public String EnergyConsumptionValue = "//app-ranking-widget//div/div[1]/div/app-widget-card/pfe-kpi-card/div[2]";
        public String RecoveredEnergyUsedEnergy = "//app-ranking-widget-data-handler//div[contains (text(),'Recovered energy/Used energy')]";
        public String RecoveredEnergyUsedEnergyValue = "//app-ranking-widget//div/div[2]/div/app-widget-card/pfe-kpi-card/div[2]";
        ...
        public String AirConditioningEnergyUsedEnergyValue = "//app-ranking-widget//div/div[3]/div/app-widget-card/pfe-kpi-card/div[2]";
        public String EnergyEfficiencyScore="//app-ranking-widget-data-handler//div[contains (text(),'Energy efficiency score')]";
        public String EnergyEfficiencyScoreValue = "//pfe-tab-panel[2]//app-widget-card-extended//div[@class='value']";
